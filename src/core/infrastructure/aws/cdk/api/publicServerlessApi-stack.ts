...
export class PublicServerlessApiStack extends Stack {
    ...
    constructor(
        ...
        const restApiName = this.idBuilder.createStageBasedId(
    ...
    private addUserEndpoints(
        ...
        const getUserByUsername = new NodejsFunction(this, apiLambdaId, {
            ...
            entry: path.join(
                __dirname,
                lambdaApiEndpointConfig.getUserByUserId.codePath
            ),
            handler: lambdaApiEndpointConfig.getUserByUserId.lambdaFunctionName,
            ...this.getApiLambdaProps(),
    ...
    private createDynamoAllowPolicyForAllDynamoIndexes(
        ...
        return new PolicyStatement({
            ...
            effect: Effect.ALLOW,
            resources: dynamoTableData.globalSecondaryIndexes.map(
                (gsi) => gsi.arn
            ),
        });
    }
