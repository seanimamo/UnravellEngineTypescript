 ...
 * @see {@link https://docs.stripe.com/api/events/types?event_types-invoice.payment_succeeded=#event_types-customer.subscription.created}
 * @see {@link BasicStripeSubscriptionCreatedWebhook}
 */
export interface IStripeSubscriptionCreatedWebhook {
    /**
...
export { BasicStripeSubscriptionCreatedWebhook } from "./BasicStripeSubscriptionCreatedWebhook";
